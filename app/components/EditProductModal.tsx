  ...
  useEffect(() => {
    if (product) {
      setFormData({
        ...
        autoDiscount: product.autoDiscount?.toString() || '',
        autoDiscountType: product.autoDiscountType || 'nominal'
      })
    }
  }, [product])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.autoDiscount) {
        updateData.autoDiscount = parseFloat(formData.autoDiscount)
        updateData.autoDiscountType = formData.autoDiscountType
      } else {
        updateData.autoDiscount = null
        updateData.autoDiscountType = null
      }
